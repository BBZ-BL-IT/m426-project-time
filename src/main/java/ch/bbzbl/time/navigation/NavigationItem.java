...
@Tag("vcf-nav-item")
public class NavigationItem extends Component {
     ...
     */
    public NavigationItem(String label, String path) {
        setPath(path);
        setLabel(label);
    }
     ...
     */
    public NavigationItem(String label, Class<? extends Component> view) {
        setPath(view);
        setLabel(label);
    }
     ...
     */
    public NavigationItem(String label, String path, Component icon) {
        setPath(path);
        setLabel(label);
        setIcon(icon);
    }
     ...
     * @param icon  the icon for the item
     */
    public NavigationItem(String label, Class<? extends Component> view, Component icon) {
        setPath(view);
        setLabel(label);
        setIcon(icon);
    }
     ...
     */
    public NavigationItem addItem(NavigationItem... appNavItems) {
        for (NavigationItem appNavItem : appNavItems) {
     ...
     * @return this item for chaining
     */
    public NavigationItem removeItem(NavigationItem appNavItem) {
     ...
     * @return this item for chaining
     */
    public NavigationItem removeAllItems() {
     ...
     */
    public NavigationItem setLabel(String label) {
     ...
     * @return this instance for chaining
     */
    public NavigationItem setPath(String path) {
     ...
     * @return this instance for chaining
     */
    public NavigationItem setPath(Class<? extends Component> view) {
     ...
     * @return this instance for chaining
     */
    public NavigationItem setIcon(Component icon) {
     ...
     */
    public NavigationItem setExpanded(boolean value) {
        if (value) {
